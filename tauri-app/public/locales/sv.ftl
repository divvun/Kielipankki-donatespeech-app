...
ThemesPageBody1Text = Välj ett ämne du vill prata om. Tjänsten vägleder dig vidare.
...
LanguageNorthSami = Nordsamiska

LanguageLuleSami = Lulesamiska

LanguageSouthSami = Sydsamiska

LanguageInariSami = Enaresamiska

LanguageSkoltSami = Skoltsamiska
