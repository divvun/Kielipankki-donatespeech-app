...
TermsHelloBody = Les først denne grunnleggjande informasjonen om prosjektet. Deretter kan du velje eit emne som interesserer deg og donere talen din.
...
TermsAppropriateUseBody = Denne applikasjonen er ikkje meint for delt bruk. Alle donatorar må bruke si eiga eining når dei donerer.
...
TermsAcceptBody = Ved å trykke på Eg godtar-knappen nedanfor godtar eg vilkåra ovanfor for taledonasjon. Om eg er under 18 år, godtar verja mi vilkåra på mine vegne.

TermsAccept = Eg godtar

RecordingStoppedLimitTitle = Opptak avbrote
