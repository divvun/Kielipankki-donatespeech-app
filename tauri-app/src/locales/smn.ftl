...
StartRecording = smn Äänitä

StopRecording = smn Lopeta äänitys
...
DonatedLabelText = smn OLET LAHJOITTANUT
...
InviteFriendTemplate = smn Lahjoitin puhettani { $param0 } minuuttia. Lahjoita sinäkin! #hashtag https://example.com

InviteFriendNewbieTemplate = smn Lahjoitin juuri puhettani. Lahjoita sinäkin! #hashtag https://example.com
...
TermsHelloBody = smn Lue ensin nämä perustiedot hankkeesta. Sen jälkeen voit valita sinua kiinnostavan aihepiirin ja lahjoittaa puhettasi.
...
TermsOwnershipTitle = smn Kuka?

TermsOwnershipBody1 = smn Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae libero nec massa sollicitudin lobortis. Nulla facilisi. Aenean quis aliquam erat. Aliquam ac egestas augue. Sed sed scelerisque massa, a sodales nunc. Nulla nec felis ipsum. In hac habitasse platea dictumst. Curabitur eu congue neque 

TermsOwnershipLink = smn Tietosuoja

TermsOwnershipLinkUrl = https://example.com/tietosuoja

TermsOwnershipBody2 = smn  -sivulla esitettyjä periaatteita noudattaen.

TermsVoluntaryTitle = smn Täysin vapaaehtoista!

TermsVoluntaryBody = smn Puheen lahjoittaminen ja henkilötietojen ilmoittaminen on täysin vapaaehtoista.

TermsPrivacyTitle = smn Miten henkilötietoja käsitellään?

TermsPrivacyBody = smn Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Mauris maximus quis elit sit amet ornare. Nam dui arcu, ornare quis diam ac, commodo aliquam quam.

TermsPrivacyLink = smn Lisätietoa henkilötietojen käsittelystä
...
TermsAppropriateUseBody = smn Tämä sovellus ei ole tarkoitettu yhteiskäyttöön. Kaikkien lahjoittajien tulee käyttää lahjoittaessaan omaa laitettaan.

TermsAdditionalTitle = smn Lisätietoa

TermsAdditionalWebsite = smn Kampanjan sivusto: 

TermsAdditionalWebsiteLink = example.com

TermsAdditionalWebsiteUrl = https://example.com

TermsAdditionalContact = smn Helsingin yliopisto, Kielipankki
...
TermsAcceptBody = smn Painamalla alla olevaa Hyväksyn-nappia hyväksyn edellä olevat puheen lahjoittamisen ehdot. Jos olen alle 18-vuotias, huoltajani hyväksyy ehdot puolestani.

TermsAccept = smn Hyväksyn

RecordingStoppedLimitTitle = smn Äänitys keskeytetty
...
LanguageNorwegian = smn Norja (bokmål)

LanguageNorthSami = smn Pohjoissaame

LanguageLuleSami = smn Luulajansaame

LanguageSouthSami = smn Eteläsaame

LanguageInariSami = smn Inarinsaame

LanguageSkoltSami = smn Koltansaame
