...
ThemesPageBody2Text = Dïenesjem datnem vijriebasse bïhkede

StartButtonText = Aelhkie amma!

StartRecording = Spealedh dïjse
...
DetailsButtonText = Vielie bïevnesh

ExitButtonText = Orrijidh

DonatedLabelText = Datne donereme

ChooseOptionText = Veeljh akte alternatijve
...
TermsVoluntaryBody = Gïele jïh almetjelaavenjassh vedtedh, lea eevre frijje væljoen mietie
...
RecordingStoppedLimitTitle = Orrijamme

RecordingStoppedLimitMessage = Tïjjem orrijamme, gæjhtoe donasjovnen åvteste

RecordingApproachingLimitMessage = Tïjjem rætnoe nåhkemem jakseme, medtie 1 minuhte aajmene

ChooseLanguageTitle = Veeljh gïele

LanguageFinnish = Såevmiengïele

LanguageNorwegian = Nöörjengïele (bokmål)

LanguageNorthSami = Noerhtesaemien

LanguageLuleSami = Julevsaemien

LanguageSouthSami = Åarjelsaemien

LanguageInariSami = Aaneresaemien

LanguageSkoltSami = Skåaltesaemien

LanguageSwedish = Daaroengïele
