...
DonatedLabelText = OLET LAHJOITTANUT
...
InviteFriendTemplate = Lahjoitin puhettani { $param0 } minuuttia. Lahjoita sinäkin! #hashtag https://example.com

InviteFriendNewbieTemplate = Lahjoitin juuri puhettani. Lahjoita sinäkin! #hashtag https://example.com

OnboardingTitle = Onboarding-otsikko
...
TermsHelloBody = Lue ensin nämä perustiedot hankkeesta. Sen jälkeen voit valita sinua kiinnostavan aihepiirin ja lahjoittaa puhettasi.
...
TermsVoluntaryBody = Puheen lahjoittaminen ja henkilötietojen ilmoittaminen on täysin vapaaehtoista.
...
TermsAppropriateUseBody = Tämä sovellus ei ole tarkoitettu yhteiskäyttöön. Kaikkien lahjoittajien tulee käyttää lahjoittaessaan omaa laitettaan.
...
TermsAdditionalContact = Helsingin yliopisto, Kielipankki
...
TermsAcceptBody = Painamalla alla olevaa Hyväksyn-nappia hyväksyn edellä olevat puheen lahjoittamisen ehdot. Jos olen alle 18-vuotias, huoltajani hyväksyy ehdot puolestani.

TermsAccept = Hyväksyn

RecordingStoppedLimitTitle = Äänitys keskeytetty
...
LanguageNorwegian = Norja (bokmål)

LanguageNorthSami = Pohjoissaame

LanguageLuleSami = Luulajansaame

LanguageSouthSami = Eteläsaame

LanguageInariSami = Inarinsaame

LanguageSkoltSami = Koltansaame
